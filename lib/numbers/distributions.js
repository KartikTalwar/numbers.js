 ...
 * @return {Number} computed probability
 */
 distribution.gaussian = function(x, mu, sigmaSquared) {
  return distribution.normal(x, mu, sigmaSquared);
 }
 ...
 * @return {Number} computed probability
 */
 distribution.bellCurve = function(x, mu, sigmaSquared) {
  return distribution.normal(x, mu, sigmaSquared);
 }